...
const CanMsg HONDA_BG_LONG_TX_MSGS[] = {{0xE4, 0, 5}, {0x1DF, 0, 8}, {0x1EF, 0, 8}, {0x1FA, 0, 8}, {0x30C, 0, 8}, {0x33D, 0, 5}, {0x39F, 0, 8}, {0x18DAB0F1, 0, 8}, {0x560, 2, 8}};  // Bosch Giraffe w/ gas and brakes
const CanMsg HONDA_BH_LONG_TX_MSGS[] = {{0xE4, 1, 5}, {0x1DF, 1, 8}, {0x1EF, 1, 8}, {0x1FA, 1, 8}, {0x30C, 1, 8}, {0x33D, 1, 5}, {0x39F, 1, 8}, {0x18DAB0F1, 1, 8}, {0x560, 1, 8}};  // Bosch Harness w/ gas and brakes
...
static int honda_rx_hook(CAN_FIFOMailBox_TypeDef *to_push) {
  ...
  if (valid) {
    ...
    int bus_rdr_car = (honda_hw == HONDA_BH_HW) ? 1 : 2;  // radar bus, car side
